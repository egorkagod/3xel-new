...
export default function GoodPage() {
    ...
    return (
        <div className={classes.globalContainer}>
            <div style={{ width: '100%', height: '100%', backgroundImage: variantId ? `url(${product.variants.find(v => v.id === variantId).image})` : 'none', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', borderRadius: '12px' }}></div>
