...
export default function MainUpperSection() {
    ...
    const slides = [
        'https://3xel.ru/media/images/carusel/1.png',
        'https://3xel.ru/media/images/carusel/2.png',
        'https://3xel.ru/media/images/carusel/3.png',
        'https://3xel.ru/media/images/carusel/4.png',
        'https://3xel.ru/media/images/carusel/5.png',
    ]
